...
The template ships placeholder copies of Repo-preview.png and Repo-preview-thumb.png
in [/images](../../images), and the README already links the first one. Replace
both files in place so that link keeps working.
